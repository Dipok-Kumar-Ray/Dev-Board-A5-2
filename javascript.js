...
function handleClick(buttonId, isDoubleAlert = false) {
    if (isDoubleAlert) {
        alert("Board Update " + buttonId); // First alert
        alert("Congratuletion " + buttonId); // Second alert
    } else {
    ...
    button.classList.remove("btn-primary", "btn-success", "btn-error", "btn-warning", "btn-info", "btn-secondary");

    // Add the gray color when disabled
    button.classList.add("bg-gray-400", "text-white", "cursor-not-allowed", "border-gray-500");
